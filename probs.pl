...
result(17,pass,'Mickey_out250_known_last147_0_u',[249.26,1650742239,20.3,138.58,150056,928576292,1890044740,38.51,491.1,404579504,455.58,2462684,3545204128,84.53]).
...
result(71, redo, 'minormax...', ["FRAT pass, DRAT fail. Check-only drat-trim succeeds, but LRAT production is 'killed'. Did not run out of disk space."]).
result(72, redo, 'mod2...', ["FRAT pass, DRAT fail. Check-only drat-trim succeeds, but LRAT production is 'killed'. Did not run out of disk space."]).
...
result(75, pass,'rubikcube701-sc2017',[1700.32,1489288464,8.3,210.85,88756,850805857,1774673851,41.65,1698.01,519362159,2611.05,2119636,1914538251,46.75]).
...
result(85, redo, _, ["FRAT pass, DRAT fail"]).
