...
result(1, redo, '11pipe_11_ooo-sc2011', ["Insufficient disk space"]).
...
result(35, redo, 'b_unsat', []).

result(41, redo, _, ["broken pipe"]).

result(46, redo, _, ["broken pipe"]).
