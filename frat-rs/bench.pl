...
main([CNF_FILE]) :- 
  ...
  delete_file("test.frat.temp"), % test.frat, test.lrat
  ...
  delete_file("test.frat"), % test.frat.temp
  ...
  atomic_list_concat(
    [ DIMACS_FRAT_TIME, FRAT_SIZE, MISSING, FRAT_LRAT_TIME, FRAT0_LRAT_TIME, 
      FRAT1_LRAT_TIME, TEMP_SIZE, FRAT_LRAT_SIZE, FRAT_LRAT_CHK_TIME,
